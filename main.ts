        ...
        *,
        ...
        @media (hover:hover) {
            ...
            nav ul li ul {
                ...
                padding: .25rem .5rem;
                margin-top: .5rem;
                margin-left: calc(-.5rem - var(--border-width));
                background-color: var(--background-color);
        ...
        summary {
            margin: calc(-.5rem - var(--border-width));
        ...
        textarea:focus {
            ...
            outline: 0;
            box-shadow: 0 0 .2rem .01rem var(--border-hover-color)
        }
        ...
        kbd {
            ...
            border-radius: var(--border-radius);
            box-shadow: inset 0 0 0 .2rem var(--background-color)
        }

        kbd kbd {
            border: unset;
            border-radius: 0;
            box-shadow: inset 0 -.2rem 0 0 var(--background-color), inset 0 .2rem 0 0 var(--background-color)
        }
